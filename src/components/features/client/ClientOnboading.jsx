...
const features = [
  {
    ...
    description:
      "Custom and platform-based websites built for performance, speed, and business growth.",
  ...
  },
  {
    ...
    price: "Starting at ₹10,000/- Video",
    icon: Video,
    image: CgiVideoIcon,
  },
  {
  ...
  },
  {
    ...
    price: "Starting at ₹500/- Creative",
    icon: Palette,
  ...
  },
  {
    ...
    title: "Voice Agent",
    description:
      "Voice Agent (AI Voice Bot / Call Automation) for sales, support, and follow-ups.",
    price: "Starting at ₹50,000/-",
    icon: PhoneCall,
