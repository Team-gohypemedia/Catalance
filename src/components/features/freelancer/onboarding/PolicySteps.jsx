...
export const DeliveryPolicyStep = ({ formData, updateFormField }) => (
    <div className="space-y-6">
        ...
        />
        <div className="rounded-xl border border-white/10 bg-transparent dark:bg-transparent p-6 space-y-4">
...
export const BioStep = ({ formData, updateFormField, queueAdvance, renderContinueButton }) => (
    <div className="space-y-6">
        ...
        <Textarea
            ...
            className="bg-transparent dark:bg-transparent border-white/10 text-white placeholder:text-white/30 min-h-[160px] rounded-xl p-4"
        />
        <label className="flex items-start gap-3 text-white/70 text-sm cursor-pointer rounded-xl border border-white/10 bg-transparent dark:bg-transparent p-4">
            <input
                type="checkbox"
    ...
    <div className="space-y-6">
        ...
        <div>
            ...
            <Input
                ...
                maxLength={6}
                className="mt-2 bg-transparent dark:bg-transparent border-white/10 text-white placeholder:text-white/30 text-center text-2xl tracking-widest"
            />
        </div>
        {isSubmitting && (
