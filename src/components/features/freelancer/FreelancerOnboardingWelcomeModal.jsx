...
const FreelancerOnboardingWelcomeModal = ({
  ...
  <AlertDialog open={open} onOpenChange={() => {}}>
    <AlertDialogContent
      ...
      className="origin-center scale-[0.75] w-[min(94vw,48rem)] max-w-[min(94vw,48rem)] overflow-hidden rounded-[32px] border border-primary/20 bg-[#0e0e0f]/96 p-0 text-white shadow-[0_36px_120px_rgba(0,0,0,0.62)] backdrop-blur-xl sm:max-w-[min(94vw,48rem)]"
    >
      <div className="relative overflow-hidden">
        ...
        <div className="relative flex flex-col gap-5 p-5 sm:p-7">
          ...
          <div className="flex justify-center pt-1">
            <div className="flex h-[70px] w-[70px] items-center justify-center rounded-[20px] border border-primary/20 bg-[linear-gradient(180deg,color-mix(in_srgb,var(--primary)_8%,transparent),rgba(255,255,255,0.01))] shadow-[0_18px_40px_rgba(0,0,0,0.3)]">
              <Sparkles className="size-8 text-primary" />
            </div>
          </div>

          <AlertDialogHeader className="items-center space-y-3 text-center sm:text-center">
            <AlertDialogTitle className="text-[2.25rem] font-semibold tracking-[-0.05em] text-white sm:text-[3.1rem]">
              Welcome to <span className="text-primary">Catalance</span>
            </AlertDialogTitle>
            <AlertDialogDescription className="mx-auto max-w-[39rem] text-center text-[1rem] leading-7 text-white/66">
          ...
          <div className="grid gap-3 sm:grid-cols-3 sm:gap-4">
            {welcomeHighlights.map((item) => (
              <div
                key={item.title}
                className="rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] px-4 py-4 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]"
              >
                <div className="mx-auto flex size-12 items-center justify-center rounded-full border border-white/8 bg-[#1a1a1b] shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                  <item.icon className="size-6 text-primary" />
                </div>
                <p className="mt-4 text-[0.98rem] font-semibold uppercase tracking-[0.18em] text-white">
                  {item.title}
                </p>
                <div className="mx-auto mt-2.5 h-px w-9 bg-primary" />
                <p className="mt-3 text-[0.94rem] leading-6 text-white/58">
                  {item.description}
                </p>
              </div>
            ))}
          ...
          <div className="flex items-start gap-4 rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.035),rgba(255,255,255,0.012))] px-4 py-4 sm:px-5">
            <div className="flex size-14 shrink-0 items-center justify-center rounded-full border border-white/8 bg-[#1a1a1b]">
              <Flag className="size-5 text-primary" />
            </div>
            <div className="min-w-0 pt-1 text-left">
              <p className="text-[0.76rem] font-semibold uppercase tracking-[0.24em] text-primary">
                Next Step
              </p>
          ...
          <AlertDialogAction asChild>
            <Button
              ...
              className="h-14 w-full rounded-[16px] bg-primary text-lg font-semibold text-primary-foreground shadow-[0_20px_40px_color-mix(in_srgb,var(--primary)_18%,transparent)] hover:bg-primary/90"
            >
              Start Onboarding
          ...
          <div className="flex items-center justify-center gap-2 text-[0.84rem] text-white/38">
