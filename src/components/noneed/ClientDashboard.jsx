...
import ClientDashboardDialogs from "@/components/features/client/ClientDashboard/components/ClientDashboardDialogs";
import {
  ActiveChats,
  ActiveProjects,
  DraftedProposals,
...
const ClientDashboardContent = () => {
  ...
  const runningProjectProcessingId = isProcessingPayment ? projectToPay?.id : null;
  ...
  return (
    <>
      ...
      <ClientDashboardDialogs
        showViewProposal={showViewProposal}
        setShowViewProposal={setShowViewProposal}
        savedProposal={savedProposal}
        resolveProposalTitle={resolveProposalTitle}
        formatBudget={formatBudget}
        openEditProposal={openEditProposal}
        showEditProposal={showEditProposal}
        setShowEditProposal={setShowEditProposal}
        editForm={editForm}
        setEditForm={setEditForm}
        saveProposalChanges={saveProposalChanges}
        ...
        setViewingFreelancer={setViewingFreelancer}
        setShowFreelancerProfile={setShowFreelancerProfile}
        ...
        showSuspensionAlert={showSuspensionAlert}
        setShowSuspensionAlert={setShowSuspensionAlert}
