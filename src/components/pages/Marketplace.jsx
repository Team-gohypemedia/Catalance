  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <div className="relative z-20 mx-auto mt-4 flex w-full max-w-[1280px] flex-col gap-8 px-4 pb-16 sm:gap-10 sm:px-6 lg:px-8">
        ...
        <section id="why-choose-catalance" className="relative py-4">
          {/* Warm cream background card */}
          <div className="relative rounded-[40px] overflow-hidden border border-orange-100/60 dark:border-white/10 bg-[#FDF7F0] dark:bg-[#18130d] px-5 py-14 sm:px-10 sm:py-16">

            {/* Header */}
            <div className="text-center mb-12 space-y-4">
              <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight leading-[1.1] text-[#1a1209] dark:text-white">
                Why Businesses Choose{" "}
                <br className="hidden sm:block" />
                <span className="text-primary">Catalance</span>
              </h2>
              <p className="text-[#6b5c45] dark:text-slate-400 text-base max-w-md mx-auto leading-relaxed">
              ...
              <div className="flex items-center justify-center gap-2 pt-2">
                <div className="flex -space-x-2">
                  {["t1", "t2", "t3", "t4"].map((seed) => (
                    <div key={seed} className="w-8 h-8 rounded-full overflow-hidden ring-2 ring-[#FDF7F0] dark:ring-[#18130d] bg-orange-100">
                      <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${seed}`} alt="" className="w-full h-full object-cover" />
                    </div>
                  ))}
                </div>
                <span className="text-sm text-[#6b5c45] dark:text-slate-400">
                  Trusted by{" "}
                  <span className="font-bold text-primary">300+ Businesses</span>
                </span>
              </div>
            </div>
            ...
            <div className="max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-2 rounded-2xl overflow-hidden mb-0 shadow-sm">
                {/* Catalance header */}
                <div className="bg-primary flex items-center justify-center gap-2.5 py-4 px-4">
                  <div className="w-7 h-7 rounded-full bg-white/20 flex items-center justify-center">
                    <div className="w-3.5 h-3.5 rounded-full bg-white" />
                  </div>
                  <span className="text-white font-bold text-base sm:text-lg">Catalance</span>
                </div>
                {/* VS badge */}
                {/* Other Platforms header */}
                <div className="bg-[#e8e5e0] dark:bg-[#2a2520] flex items-center justify-center gap-2 py-4 px-4 relative">
                  <div className="absolute left-0 -translate-x-1/2 w-8 h-8 rounded-full bg-[#f5f1ec] dark:bg-[#1a1512] border border-[#ddd9d3] dark:border-white/10 flex items-center justify-center z-10">
                    <span className="text-[9px] font-extrabold text-[#888] uppercase">vs</span>
                  </div>
                  <Users className="w-5 h-5 text-[#888] dark:text-slate-400" />
                  <span className="text-[#555] dark:text-slate-300 font-semibold text-base sm:text-lg">Other Platforms</span>
                </div>
              </div>
              ...
              <div className="divide-y divide-[#e8e0d5] dark:divide-white/10 bg-white/70 dark:bg-white/[0.03] rounded-b-2xl border border-t-0 border-[#e8e0d5] dark:border-white/10">
                {[
                  ...
                  <div key={idx} className="grid grid-cols-2">
                    {/* Catalance column */}
                    <div className="flex items-start gap-3 py-4 px-4 sm:px-6 border-r border-[#e8e0d5] dark:border-white/10">
                      <div className="mt-0.5 shrink-0 w-6 h-6 rounded-full bg-primary/10 flex items-center justify-center">
                        <Check className="w-3.5 h-3.5 text-primary" strokeWidth={3} />
                      </div>
                      <div>
                        <p className="text-sm font-bold text-[#1a1209] dark:text-white leading-snug">{row.catalance.title}</p>
                        <p className="text-xs text-[#7a6a55] dark:text-slate-400 mt-0.5 leading-relaxed">{row.catalance.desc}</p>
                      </div>
                    </div>
                    {/* Other platforms column */}
                    <div className="flex items-start gap-3 py-4 px-4 sm:px-6">
                      <div className="mt-0.5 shrink-0 w-6 h-6 rounded-full bg-red-100/80 dark:bg-red-900/20 flex items-center justify-center">
                        <X className="w-3.5 h-3.5 text-red-500" strokeWidth={3} />
                      </div>
                      <div>
                        <p className="text-sm font-bold text-[#1a1209] dark:text-white leading-snug">{row.other.title}</p>
                        <p className="text-xs text-[#7a6a55] dark:text-slate-400 mt-0.5 leading-relaxed">{row.other.desc}</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="text-right mt-4">
                <span className="text-xs text-primary italic font-medium">*Terms & Conditions Apply.</span>
              </div>
            </div>
          </div>
        </section>
