    ...
    <div className={rootClassName}>
      <div className="absolute inset-0">
        <div
          ...
          style={{
            background:
              "radial-gradient(100% 100% at 0% 0%, color-mix(in srgb, var(--primary) 22%, black) 0%, black 100%)",
            mask: "radial-gradient(125% 100% at 0% 0%, rgb(0, 0, 0) 0%, rgba(0, 0, 0, 0.224) 88.2883%, rgba(0, 0, 0, 0) 100%)",
          }}>
          {/* Skewed fading primary streaks */}
          <div
      ...
      <div
        className="absolute inset-0 bg-gradient-radial from-slate-800/20 via-transparent to-transparent" />
      {/* Content */}
