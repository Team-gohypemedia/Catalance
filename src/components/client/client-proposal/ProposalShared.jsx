...
export const ProposalSectionCard = ({ title, description, children, className }) => (
...
export const ProposalStructuredList = ({
  items,
...
export const ProposalMetric = ({ icon: Icon, label, value, valueClassName }) => (
...
export const ProposalSummaryItem = ({
  label,
  value,
  valueClassName,
  className,
...
export const ProposalFreelancerAvatars = ({
  proposal,
