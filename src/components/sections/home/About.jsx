...
const ValueCard = ({ icon: Icon, title, description, isDark }) => (
  <Card
    className={`border-none shadow-none bg-transparent overflow-hidden group relative`}
  >
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-20">
        ...
        <div className="text-center max-w-4xl mx-auto mb-16">
          ...
          >
            We built Catalance to bridge the gap between extraordinary talent
            and visionary enterprises. No friction, just results.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center mb-32">
          <div className="relative">
            <div
              className={`absolute -inset-4 rounded-3xl bg-gradient-to-r from-primary to-purple-600 opacity-20 blur-2xl ${isDark ? "opacity-20" : "opacity-10"}`}
            />
            <div
              className={`relative p-8 md:p-12 rounded-3xl border overflow-hidden ${
                isDark
                  ? "bg-white/5 border-white/10"
                  : "bg-white border-black/5 shadow-2xl shadow-primary/5"
              }`}
            >
              <h3 className="text-3xl font-bold mb-6">Our Mission</h3>
              <p className={`${mutedTextColor} text-lg mb-6 leading-relaxed`}>
                To empower trusted relationships between businesses and
                independent professionals. We believe the future of work is
                flexible, meritocratic, and borderless.
              </p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className={`${mutedTextColor} text-lg leading-relaxed`}>
                Whether you're a startup scaling up or a professional breaking
                free from the 9-to-5, Catalance provides the infrastructure for
                your success.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <Card
                className={`bg-transparent border ${isDark ? "border-white/10" : "border-black/10"}`}
              >
                <CardContent className="p-6">
                  <Rocket className="w-8 h-8 text-blue-500 mb-4" />
                  <h4 className="font-bold text-lg mb-2">Moving Fast</h4>
                  <p className={`text-sm ${mutedTextColor}`}>
                    Connect and start working within 24 hours.
                  </p>
                </CardContent>
              </Card>
              <Card
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className={`text-sm ${mutedTextColor}`}>
                    Talent from over 120 countries at your fingertips.
                  </p>
                </CardContent>
              </Card>
            </div>
        ...
        <div className="relative rounded-[2.5rem] overflow-hidden">
          ...
          <div className="relative z-20 p-12 md:p-24 text-center max-w-3xl mx-auto">
            ...
            >
              Join thousands of forward-thinking companies and independent
              professionals.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className={`h-14 px-8 text-lg rounded-full border-2 ${isDark ? "bg-black/50 border-white/20 text-white hover:bg-white/10" : "bg-white/50 border-black/10 text-black hover:bg-white"} backdrop-blur-md transition-all`}
                >
                  Contact Sales
                </Button>
              </Link>
