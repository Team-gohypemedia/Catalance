  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto flex flex-col gap-6 md:gap-10">
        ...
        {/* 2. Contact Grid (5 horizontal cards) */}
        <div className="w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-4">
          {[
            ...
            { title: "WhatsApp Us", value: "+91 7056063693", link: "https://wa.me/917056063693" },
