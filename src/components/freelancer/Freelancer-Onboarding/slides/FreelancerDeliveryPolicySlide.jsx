    ...
    <div className="w-full max-w-5xl space-y-8">
      ...
      <div className="rounded-2xl border border-white/10 bg-card p-6 sm:p-7">
        <div className="space-y-2">
          <h2 className={cn(ONBOARDING_SECTION_TITLE_CLASS, "text-[#facc15]")}>Delivery &amp; Revision Policy</h2>
        ...
        <div className="mt-5 space-y-2">
          <h3 className={cn(ONBOARDING_FIELD_LABEL_CLASS, "text-[#facc15]/90")}>Key SOP Rules</h3>
