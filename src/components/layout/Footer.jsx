...
const Footer = () => {
  ...
  return (
    <footer
      className={`relative w-full pt-16 pb-12 overflow-hidden transition-colors duration-300 ${isDark ? "bg-black bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-black via-[#0a0a0a] to-black" : "bg-white"}`}
    >
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <a className="flex items-center gap-2 group/logo w-fit" href="#">
              <div className="w-10 h-10 rounded-lg bg-white/10 border border-[#f2cc0d]/30 flex items-center justify-center overflow-hidden">
                <img src={logo} alt="Catalance logo" className="h-9 w-9 object-contain" />
              </div>
              <span
                className={`text-2xl font-bold tracking-tight group-hover/logo:text-[#f2cc0d] transition-colors ${isDark ? "text-white" : "text-gray-900"}`}
              >
                Catalance
              </span>
            </a>
            ...
            <div className="flex items-center gap-4 mt-2">
              {[
                ...
                <a
                  key={index}
                  className={`group flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 hover:shadow-[0_0_15px_rgba(242,204,13,0.4)] hover:bg-[#f2cc0d] hover:text-[#181711] ${Social.color} ${isDark ? "bg-white/5 text-[#bab59c]" : "bg-black/5 text-gray-600"}`}
                  href={Social.href}
          ...
          <div className="lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col gap-4">
              <h3
                className={`font-bold text-sm uppercase tracking-wider ${isDark ? "text-white" : "text-gray-900"}`}
              >
                Platform
              </h3>
        ...
        {/* Newsletter Section */}
        <div
          className={`border-t pt-12 pb-12 mb-8 ${isDark ? "border-white/10" : "border-black/5"}`}
        >
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
            <div className="flex flex-col gap-2 max-w-md">
              ...
              <p
                className={`text-sm ${isDark ? "text-[#bab59c]" : "text-gray-600"}`}
              >
                Get the latest insights on enterprise scaling and workforce
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-4 border-t border-transparent">
          ...
          <div className="flex flex-wrap justify-center md:justify-end items-center gap-6">
            <div
              className={`flex items-center gap-2 px-3 py-1 rounded-full border ${isDark ? "bg-white/5 border-white/5" : "bg-black/5 border-black/5"}`}
            >
              ...
              <span
                className={`text-xs font-semibold ${isDark ? "text-slate-300" : "text-gray-600"}`}
              >
