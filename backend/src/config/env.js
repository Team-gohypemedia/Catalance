...
const envSchema = z.object({
  ...
  SMTP_SECURE: z.preprocess((v) => v === "true" || v === true, z.boolean()).optional().default(true),
...
try {
  ...
  const fallbackEnv = {
    ...
    SMTP_USER: process.env.SMTP_USER || "info@catalance.in",
    SMTP_PASS: process.env.SMTP_PASS || "Gohypemedia@2026",
    SMTP_FROM_EMAIL: process.env.SMTP_FROM_EMAIL || "Catalance <info@catalance.in>",
